            ...
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px] bg-wh">
                ...
                <h2 class="text-4xl font-semibold">
                    Let's Connect! <div class="mt-2"> We're just a <span class="bg-blue-500 text-white">click away </span></div>
                </h2>
              </div>
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color">
                        Find Us in Dammam, Saudi Arabia                      <div>
                        <a href="https://goo.gl/maps/HF5g28VHJ5HnNdYF9" target="_blank">View on Google Map
</a>
                      </div>
                ...
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div class="">
                    ...
                    <div class="">
                      <span><i class="fas fa-envelope text-4xl"></i></span><a href="mailto:contact@estehdath.com" class="text-base text-body-color"> contact@estehdath.com</a>
                    </div>                   
                    <div class="mt-2">
                      <span><i class="fa fa-phone text-4xl"></i></span><a href="tel:+966532688777" class="text-base text-body-color"> 0532688777</a>
                    </div>                   
