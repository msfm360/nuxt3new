<template lang="">
  ...
  >
    ...
    <img :src="currentImage" class="w-[48rem] xl:max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 max-sm:w-[30rem] sm:w-[57rem] " alt="images that show our materials and equipment">
    </div>
